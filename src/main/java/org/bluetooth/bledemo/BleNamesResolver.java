...
public class BleNamesResolver {
	...
	static {
		...
		mServices.put("00001234-0000-1000-8000-00805f9b34fb", "Weight Measurement");
		mServices.put("0000AA10-0000-1000-8000-00805f9b34fb", "Accelerometer");
		mServices.put("0000AA40-0000-1000-8000-00805f9b34fb", "Barometer");
		mServices.put("0000AA40-0000-1000-8000-00805f9b34fb", "magnetrometer");
		mServices.put("0000AA00-0000-1000-8000-00805f9b34fb", "temperatur");
		mServices.put("7280d0b4-c973-11e4-8731-1681e6b88ec1", "temperatur");
		mServices.put("a6322521-eb79-4b9f-9152-19daa4870418", "adc");
		...
		//mCharacteristics.put("b928cd15-ca32-11e4-8731-1681e6b88ec1", "Temperature Measurement");
		mCharacteristics.put("f90ea016-f673-45b8-b00b-16a088a2ed61", "Temperature Raw value");
		...
		mCharacteristics.put("b928cc14-ca32-11e4-8731-1681e6b88ec1", "Magnetometer");
		mCharacteristics.put("b928ceee-ca32-11e4-8731-1681e6b88ec1", "Gyrometer");
		mCharacteristics.put("b928c85e-ca32-11e4-8731-1681e6b88ec1", "Barometer");
		mCharacteristics.put("b928cab6-ca32-11e4-8731-1681e6b88ec1", "Accelerometer");
		mCharacteristics.put("f90ea017-f673-45b8-b00b-16a088a2ed61", "ADC Raw-value");
