...
public class HRDemoActivity extends Activity {
	...
	final static private UUID mADCServiceUuid = BleDefinedUUIDs.Service.ADC_Services;
	final static private UUID mAccCharacteristicUuid = BleDefinedUUIDs.Characteristic.ACC;
	final static private UUID mMagCharacteristicUuid = BleDefinedUUIDs.Characteristic.MAG;
	final static private UUID mGyroCharacteristicUuid = BleDefinedUUIDs.Characteristic.GYRO;
	final static private UUID mBarCharacteristicUuid = BleDefinedUUIDs.Characteristic.BAR;
	final static private UUID mADCCharacteristicUuid = BleDefinedUUIDs.Characteristic.ADC;
	...
	private void startSearchingForHr() {
		...
		// Heart Rate service
		final UUID[] uuids = new UUID[] { mADCServiceUuid };
	...
	private void getHrService() {
		...
		mBTService = mBTGatt.getService(mADCServiceUuid);
	...
	private void getHrCharacteristic() {
		...
		mBTValueCharacteristic = mBTService.getCharacteristic(mADCCharacteristicUuid);
	...
	private void getAndDisplayHrValue() {
    	...
    	final String description = value + "g";
